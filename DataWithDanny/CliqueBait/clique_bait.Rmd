...
SELECT TOP 1
	(SELECT TOP 1 product_name FROM meh ORDER BY product_view DESC) AS most_views,
	(SELECT TOP 1 product_name FROM meh ORDER BY added_to_cart DESC) AS most_added_to_cart,
	(SELECT TOP 1 product_name FROM meh ORDER BY bought DESC) AS most_bought
FROM
	meh
```
***
