...
Note that there are no results below for this analysis, I kept getting "Invalid Descriptor Index" when I put the code into Rmarkdown and I found no quick solution. I'll for now share my code but hopefully find a fix sooner rather than later.
...
Highly seasonal variation, and a big reliance on new products and shows to engage them. 
